...
<div class="row">
  <!-- card 篩選 -->
  <div class="col-md-3">
    <div class="card card-lightblue shadow mb-4">
      <div class="card-header py-1">
        <h6 class="m-0 font-weight-bold py-2">篩選</h6>
      </div>
      <div class="card-body pt-3 pb-0">
        <div class="dropdown mb-4">
          <button
            class="btn btn-primary dropdown-toggle mb-3" type="button" id="dropdownFilter"
            data-bs-toggle="dropdown" aria-expanded="false"
          >
            新增/取消篩選欄位
          </button>
          <ul class="dropdown-menu animated--fade-in" aria-labelledby="dropdownFilter" id="dropdown-filter">
          </ul>
          <div id="filter-fields"></div>
          <script id="tmpl-filter-field" type="text/html">
          <div class="card card-lightblue shadow mb-4">
            <div class="card-header py-1">
              <h6 class="m-0 py-2 font-weight-bold agg-name"></h6>
            </div>
  ...
  <div class="col-md-9">
    <div class="card card-lightblue shadow mb-4">
      <div class="card-header py-1">
        <h6 class="m-0 font-weight-bold py-2">資料</h6>
      </div>
      <div class="card-body">
    ...
    ajax: function(data, callback, settings){
      ...
      $.when.apply($, promises).done(function(){
        ...
        for (let supported_filter_field of ret.supported_filter_fields) {
          var label_dom = $('<li class="pl-5 form-check"></li>');
